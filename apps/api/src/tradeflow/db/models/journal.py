...
from tradeflow.db.enums import NoteEntityType
...
class TradeJournal(Base, TimestampMixin, SoftDeleteMixin):
    """Structured journal entry for reviewing trading sessions and outcomes."""

    __tablename__ = "trade_journals"
    __table_args__ = (Index("ix_trade_journals_user_id_session_date", "user_id", "session_date"),)
